...
import com.mirana.project.bean.OrderInfo
import com.mirana.project.utils.MyKafkaUtil
...
object GmvApp {
  def main(args: Array[String]): Unit = {
    ...
    val kafkaDStream: InputDStream[ConsumerRecord[String, String]] = MyKafkaUtil.getKafkaStream("TOPIC_ORDER_INFO", ssc)
